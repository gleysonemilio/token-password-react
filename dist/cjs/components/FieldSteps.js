...
var FieldSteps = function (_a) {
    ...
    var _d = (0, react_1.useState)(['']), fieldArray = _d[0], setFieldArray = _d[1];
    ...
    return (react_1["default"].createElement("div", { className: "container" }, fieldArray &&
        fieldArray.map(function (_row, index) { return (react_1["default"].createElement("input", { key: index, type: "text", id: "text-input-".concat(index), style: {
                height: '0',
